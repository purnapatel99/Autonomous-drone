...
float velocityZ, velocityX, velocityY, thrust;
...
void loop() { 
  ...
  delay(10);
  distanceY = sonarY.ping_cm();
  velocityZ = ((distanceZ - aZ)*1000)/70;
  velocityX = ((distanceX - aX)*1000)/70;
  velocityY = ((distanceY - aY)*1000)/70;
  ...
  if (pwm_value2 > 1500){
    ...
    Kp3 = 2; //set for 10cm hovering height
    Kv3 = 2.15;
